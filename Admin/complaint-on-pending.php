...
<html>
  <head>
        ...
        <title>Complaint | ON Pending</title>
...
<div class="content-wrapper">
    <section>
        <h2 style="text-align:center" class="bg-success">Complaint On Pending .....</h2>
    </section>
  <section>
      <div class="row">
        <div class="col-xs-12">
      ...
      <div class="box-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
         ...
         $cc=mysqli_connect("localhost","root","","project2");
          $abc=mysqli_query($cc , "SELECT * from complaint where status='pending...' and status2='active'");
