...
if(isset($_POST['submit'])){
    ...
    $result2 = mysqli_query($cc,"SELECT * from user_registration where password='$oldpass'");
    $abc=mysqli_fetch_Array($result2);
    if($abc>0){
   mysqli_query($cc, "UPDATE user_registration set password='$pass', repassword='$repass' where password='$oldpass'");
        ...
        <div class="row justify-content-center">
            ...
            <form action="" method="POST" onsubmit="return valid()">
                    <div class="form-group"> 
                     ...
                     <input type="password" id="password1" placeholder="Password" onkeyup="chickerror()" name="oldpass" class="form-control" >
