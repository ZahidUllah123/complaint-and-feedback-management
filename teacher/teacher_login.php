...
if(isset($_POST['submit'])){
    ...
    $result2 = mysqli_query($cc,"SELECT * from teacher_registration where email='$email'  and password='$passs'");
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5 col-sm-8 col-12">
                <img hspace="25%" src="../admin/user.png" alt="">
                ...
                <div class="form">
                    <form action="" method="POST" onsubmit=" return valadation()" class="">
                        ...
                        <div class="sign">
                            ...
                            <h6 style="display: inline-block;"> <a href="registration.html">SignUp!!</a></h6>
                        </div>
                    </form>
                </div>
            </div>
