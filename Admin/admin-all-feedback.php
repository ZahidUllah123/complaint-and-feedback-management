    ...
    <div class="box">
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped bg-success">
          ...
          $def=mysqli_query($cc , "SELECT  * FROM  feedback  ");
          ...
          <tbody>
            <tr>
              <td><?php echo $row['passion'];?></td>
              <td><?php echo $row['f_name']; ?></td>
              <td><?php echo $row['l_name'];?></td>
              <td><?php echo $row['email'];?></td>
              <td><?php echo $row['topic'];?></td>
              <td><?php echo $row['message'];?></td>
              <td><a href="delete4.php?see=<?php echo $row['email'];?>"><button class="btn btn-danger">Delete</button></a></td>
