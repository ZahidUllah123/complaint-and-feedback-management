...
if(isset($_POST['submit'])){
    ...
    $result2 = mysqli_query($cc,"SELECT * from user_registration where token='$token'");
    $abc=mysqli_fetch_Array($result2);
    if($abc>0){
   mysqli_query($cc, "UPDATE user_registration set password='$pass', repassword='$repass' where token='$token'");
