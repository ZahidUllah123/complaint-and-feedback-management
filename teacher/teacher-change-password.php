...
if(isset($_POST['submit'])){
	$oldpass= mysqli_real_escape_string($cc,htmlentities(trim(strip_tags($_POST['oldpass']))));
    ...
    $result2 = mysqli_query($cc,"SELECT * from teacher_registration where password='$oldpass'");
    $abc=mysqli_fetch_Array($result2);
    if($abc>0){
   mysqli_query($cc, "UPDATE teacher_registration set password='$pass', repassword='$repass' where password='$oldpass'");
...
<body>
        ...
        <div class="row justify-content-center">
            ...
            <form action="" method="POST" onsubmit="return valid()">
                    <div class="form-group"> 
                     ...
                     <input type="password" id="password1" placeholder="Old Password" onkeyup="chickerror()" name="oldpass" class="form-control" >
                 ...
                 <div class="form-group">
                     <label for="">New Password</label>
                     <input type="password" id="password3" placeholder="Retype New Password" onkeyup="chickerror2()" name="repass" class="form-control" >
                     <span style="color: red;" id="repass-error"></span>
                    </div>
                    <div class="form-group">
                        <input type="submit" name="submit" placeholder="Retype New Password" class="btn btn-block btn-success">
                       </div>
            </form>
    ...
    function chickerror(){
            if(Pass1=='' || Pass1=="null"){
         var Pass1= document.getElementById('pass1-error').innerHTML='Please Enter Your Password';
            }
           else{
            var Pass1 = document.getElementById('pass1-error').innerHTML='';
           }
        }
