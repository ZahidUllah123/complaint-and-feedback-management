      ...
      <div class="box-body">
        ...
        <table id="example1" class="table table-bordered table-striped bg-success">
         ...
         $cc=mysqli_connect("localhost","root","","project2");
          ...
          <tbody>
            <tr>
            <td><a href="update.php?cobj=<?php echo $xyz['complaint_no'];?>">Update |</a>
                <a href="delete.php?cobj=<?php echo $xyz['complaint_no'];?>">Delete</a></td>
              <td><?php echo $xyz['object']; ?></td>
              <td><?php echo $xyz['subject'];?></td>
              <td><?php echo $xyz['name'];?></td>
              <td><?php echo $xyz['complaint'];?></td><br>
