...
if(isset($_POST['submit'])){
    ...
    $result2 = mysqli_query($cc,"SELECT * from admin_login where password='$oldpass'");
    $abc=mysqli_fetch_Array($result2);
    if($abc>0){
   mysqli_query($cc, "UPDATE admin_login set password='$pass' where password='$oldpass'");
    ...
    <div class="container" style="position: relative;">
        <div class="row justify-content-center">
            ...
            <form action="" method="POST" onsubmit="return valid()">
                 ...
                 <div class="form-group">
                     <label for="">New Password</label>
                     <input type="password" id="password3" placeholder="Retype New Password"  name="repass" onkeyup="chickerror2()" class="form-control" >
